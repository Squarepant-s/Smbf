...
/ ___||  \/  | __ )|  ___|   Author : Tiara Pandu
\___ \| |\/| |  _ \| |_      Github : github.com/Squarepant-s
 ___) | |  | | |_) |  _|     fb : SQUAERPANTS
|____/|_|  |_|____/|_|"""
...
def jalan(z):
        for e in z + '\n':
                ...
                time.sleep(0.03)
### Bot Komen ###
def komen(): # Boleh Di Tambahin Tapi Jangan Di Ganti Gblk #
        try:
