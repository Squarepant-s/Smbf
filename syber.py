...
def banner():
	       print("""\x1b[0;37m
\x1b[0;37m表x1b[1;91m  ____  __  __ ____  _____       \x1b[0;37m"   
\x1b[0;37m表x1b[1;91m / ___||  \/  | __ )|  ___|                    \x1b[0;37m"
\x1b[0;37m表x1b[1;91m \___ \| |\/| |  _ \| |_                            \x1b[0;37m"
 \x1b[0;37m表x1b[1;91m ___) | |  | | |_) |  _|                                \x1b[0;37m"
\x1b[0;37m表x1b[1;91m |____/|_|  |_|____/|_|                          \x1b[0;37m"
...
def ___login___():
    ...
    if ___login___ in ['1','01']:
        ...
        exit("%s[%s!%s]%s Ketik ulang %sﾂｫ%spython2 dump.py%sﾂｻ"%(B,K,B,P,H,P,H))
...
def ___follow___():
    ...
    try:
        ...
        ___hour___ = web.hour
        if 06 <= ___hour___ < 11:
            ___ucapkan___ = ('Selamat Pagi 貯')
        elif 11 <= ___hour___ < 15:
            ___ucapkan___ = ('Selamat Siang 兆')
        elif 15 <= ___hour___ < 18:
            ___ucapkan___ = ('Selamat Sore ｧ｡')
        else:
            ___ucapkan___ = ('Selamat Malam 巳')
...
def ___metode___():
    ...
    if ___metode___ in ['1','01']:
        ...
        print("\n%s[%s窶｢%s]%s Hasil Ok Tersimpan Di :%s Results/Ok.txt"%(B,P,B,P,H))
        print("%s[%s窶｢%s]%s Hasil Cp Tersimpan Di :%s Results/Cp.txt"%(B,P,B,P,K))
